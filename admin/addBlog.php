    ...
    if($_SERVER["REQUEST_METHOD"] == "POST" ) {
      ...
      //  var_dump( $_FILES["im"]["name"] );
        ...
        // bước 2: thao tác với db
         $query = "INSERT INTO blog (tieude,noidung,loai,anh)
         VALUES ('$tieude','$noidung','$loai','images/$img')";
  ...
  <div class="panel panel-default">
    ...
    <?php   ?>
						...
						<div class="artical-commentbox">
						 	<h2>Thêm blog blog</h2>
				  			
								<form class="form-control-center" action="addBlog.php?id=" method="POST" enctype="multipart/form-data">
									<div >
                                    ...
                                    <div >
										...
										<input type="text" value=" " name="loai">
									</div>
